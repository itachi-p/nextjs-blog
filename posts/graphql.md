...
現状では「一度個人的にGraphQLでAPIを作ってみたことがある」くらいでいいかもしれない。  
他に優先すべき学習対象が山積しているので、軽く触れるに留めそちらを優先する。  

いっそ一定期間コードを書かずにAWS Solution Architect-Associate資格を取得した方が就活戦略としてはモアベターなのかもしれない。
